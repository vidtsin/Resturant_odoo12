	...
	models.Orderline = models.Orderline.extend({
        ...
        */
		apply_ms_data: function (data) {
			...
			//updated by Falak/Ahmad 20190718
			if (typeof data.pos_cid !== "undefined" && data.pos_cid !== this.pos_cid) {
				this.pos_cid = data.pos_cid;
			}
			if (typeof data.name !== "undefined" && data.name !== this.name) {
				this.name = data.name;
			}
			//updated by Falak/Ahmad 20190718
